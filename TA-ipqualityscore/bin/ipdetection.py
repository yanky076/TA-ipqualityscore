...
class IPDetectionCommand(StreamingCommand):
    ...
    allow_public_access_points=Option(require=False, default=True, validate=validators.Boolean())
    ...
    lighter_penalties=Option(require=False, default=True, validate=validators.Boolean())
